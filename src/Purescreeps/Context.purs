...
displayFootprintForCurrentTick colonies = traverse (\(Colony room) → (getRoomVisual room) >>= (getFootprint (Colony room) # displayFootprint)) colonies